...
core `OpenGALib.BilinearForm.inner` (`OpenGALib/Algebraic/BilinearForm/Basic.lean`)
...
(see `OpenGALib/Riemannian/Metric/MathlibBridge.lean`). -/
...
when `g = innerSL ℝ` (e.g., `OpenGALib/Riemannian/Instances/EuclideanSpace.lean`). -/
