...
mass-cancellation case the density lower bound on the cancelled mass remains
open (Conjecture~\ref{conj:density-nonexcessive}): one must show
$\Theta(\|V\|, p) > 0$ for $\|V\|$-a.e.\ $p$ in order to apply Allard's
rectifiability theorem to the cancelled mass.
\end{abstract}
...
%\input{chapters/part2/7-discussion}  % supplementary; duplicates lem:sheet-decomposition
