...
Chapter~\ref{ch:preliminaries} collects the analytical foundations: integer rectifiable currents, relative cycles, varifolds, and the sweepout framework needed for the min-max construction on manifolds with boundary.
