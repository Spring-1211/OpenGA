...
\begin{tikzpicture}[scale=0.8]
  ...
  \begin{scope}[xshift=-4.5cm]
    ...
    % Free boundary (dashed overlaid on dM)
    \draw[thick, dashed, bindB] (-1.2,0) -- (1.2,0);
    \node[below] at (0,-0.15) {$\partial M = \textcolor{bindB}{\partial_F U}$};

    % Interior boundary (dashed at neck)
    \draw[thick, dashed, bindB] (-0.5,3.5) -- (0.5,3.5);
    \node[bindB, right] at (0.65,3.5) {$\partial_I U$};

    % Label U
    \node[bindB] at (0,1.5) {\large $U$};
  ...
  \begin{scope}[xshift=3.5cm]
    ...
    \draw[thick, dashed, bindB] (0,3.5) -- (0.5,3.5);
    \node[bindB, right] at (0.65,3.5) {$\partial_I U$};

    % Label U
    \node[bindB] at (0.8,1.5) {\large $U$};

    % Free boundary (dashed line overlaid on dM)
    \draw[thick, dashed, bindB] (0,-0.3) -- (0,3.5);
    \node[bindB, left] at (-0.15,1.6) {$\partial_F U$};

    % dM label (below the neck, no overlap)
    \node[left] at (-0.15,4.8) {$\partial M$};
