...
\begin{tikzpicture}[scale=0.8]
  ...
  \begin{scope}[xshift=-4.5cm]
    ...
    \draw[very thick, brown!70!black] (-1.2,0) -- (1.2,0);
    % Free boundary (blue dashed overlaid on dM)
    \draw[thick, dashed, green!50!black] (-1.2,0) -- (1.2,0);
    \node[below] at (0,-0.15) {$\textcolor{brown!70!black}{\partial M} = \textcolor{green!50!black}{\partial_F U}$};

    % Interior boundary (dashed at neck)
    \draw[thick, dashed, green!50!black] (-0.5,3.5) -- (0.5,3.5);
    \node[green!50!black, right] at (0.65,3.5) {$\partial_I U$};

    % Label U
    \node[green!50!black] at (0,1.5) {\large $U$};
  ...
  \begin{scope}[xshift=3.5cm]
    ...
    \draw[very thick, brown!70!black] (0,5.5) -- (0,-0.8);
    ...
    \draw[thick, dashed, green!50!black] (0,3.5) -- (0.5,3.5);
    \node[green!50!black, right] at (0.65,3.5) {$\partial_I U$};

    % Label U
    \node[green!50!black] at (0.8,1.5) {\large $U$};

    % Free boundary (blue dashed line overlaid on dM)
    \draw[thick, dashed, green!50!black] (0,-0.3) -- (0,3.5);
    \node[green!50!black, left] at (-0.15,1.6) {$\partial_F U$};

    % dM label (below the neck, no overlap)
    \node[brown!70!black, left] at (-0.15,4.8) {$\partial M$};
