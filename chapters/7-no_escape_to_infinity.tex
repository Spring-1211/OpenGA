...
\begin{figure}[htbp]
  ...
  \caption{Cut–cap–insert at the slice $\overline\Gamma_{t_0}$. The hatched red part is the portion of the slice outside $\overline U$, bounded in area by $2\,\mathcal H^n(\partial_I U)$. Capping the outside within the collar and inserting a nested homotopy inside $\overline U$ enable a sweepout below $W_g(U)$.}
