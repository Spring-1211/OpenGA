...
Wickramasekera's regularity theorem (Theorem~\ref{thm:wickramasekera}) requires its input varifold to be integral. In this section, we establish integrality of the limit varifold $V$ in both the no-mass-cancellation and mass-cancellation cases. The first case uses the de~Lellis--Tasnady criterion (Proposition~\ref{prop:p2-DLT-integrality}); the second exploits nestedness of the sweepout to count sheets directly via a graphical decomposition lemma.
