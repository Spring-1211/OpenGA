...
\]
By the monotonicity formula (Proposition~\ref{prop:p2-monotonicity}), this limit exists. Moreover, $\Theta(\|V\|, p) > 0$ for every $p \in \spt\|V\|$.
...
Every stationary $n$-varifold $V$ in $(M^{n+1}, g)$ is rectifiable. More precisely, $V = \underline{v}(\Sigma, \theta)$ where $\Sigma \subset \spt\|V\|$ is $\mathcal{H}^n$-rectifiable and $\theta(p) = \Theta(\|V\|, p) > 0$ for $\mathcal{H}^n$-a.e.\ $p \in \Sigma$.
\end{proposition}
...
\begin{proof}
\xinze{Write $\mu = \|V\|$ and $f(x) = |T_x\Sigma - P|^2$, so that $E(V, B_r(p), P) = r^{-n}\int_{B_r(p)} f\,d\mu$. The function $f$ is bounded and $\mu$-measurable, with $f(p) = 0$. By the Lebesgue--Besicovitch differentiation theorem~\cite[Theorem~5.8 and \S5.3]{Mag12}, $\mu$-a.e.\ $p$ is a Lebesgue point of $f$:
\[
