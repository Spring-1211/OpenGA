...
Fix such an $r$. Since $x_i \to x_0 \in \mathfrak{m}(\Phi)$ and $\mathrm{Per}(\Omega(x_i)) \to W$, for all $i$ sufficiently large the surgery produces a modified sweepout $\tilde{\Phi}$ that agrees with $\Phi$ outside a neighborhood of $x_0$ and satisfies
\[
