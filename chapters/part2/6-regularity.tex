...
By Theorem~\ref{thm:integrality-mult-one}, $V = |\partial^*\Omega(x_0)|$. Since $V$ is a stationary integral varifold of multiplicity one, Allard regularity~\cite[Theorem~24.2]{Sim84}\xinze{Was: Federer regularity (Proposition removed)} gives that $\spt\|V\| = \partial^*\Omega(x_0)$ is a smooth, closed, embedded minimal hypersurface of multiplicity one.
