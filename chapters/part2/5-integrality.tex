...
Note that $V$ is rectifiable by Allard's rectifiability theorem (Proposition~\ref{prop:allard-rectifiability}), since it is stationary (Proposition~\ref{thm:CLS-stationary}). The main tool is the following graphical decomposition lemma.
