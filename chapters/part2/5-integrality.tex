...
\xinze{$V$ should be stationary}
Passing to a subsequence, assume $|\partial^*\Omega(x_i)|$ is non-stationary for every~$i$. We construct an explicit $I$-replacement on $I = (x_i, x_0]$ in three steps.
\begin{list}{}{\leftmargin=1.5em \parsep=\parskip \topsep=\smallskipamount \itemsep=\medskipamount}
