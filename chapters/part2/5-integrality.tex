...
This is the analog of Lemma~\ref{lem:density-lower-bound} for the cancelled mass, and is the main open question in this paper. Resolving it affirmatively---equivalently, establishing Conjecture~\ref{conj:density-nonexcessive}---closes the density lower bound $\Theta^n(\mu_{\mathrm{c}}, p) \geq c$ at $\|V\|$-a.e.\ point, from which rectifiability of $\mu_{\mathrm{c}}$ follows by Allard's theorem (Proposition~\ref{prop:allard-rectifiability}).
